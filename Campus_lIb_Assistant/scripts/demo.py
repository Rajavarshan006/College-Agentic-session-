...
QUESTIONS = [
    ("DEMO001", "Is AI in Education available? If it is, register me and send a confirmation."),
    ("DEMO001", "Can I register for Robotics Showcase?"),
]
...
def main() -> None:
    ...
    tmp = tempfile.mkdtemp(prefix="events-demo-")
    ...
    if a.crash:
        ...
        print(f"{GREEN}PASS: one new registration, one message{RESET}" if ok else f"{RED}FAIL: duplicates{RESET}")
